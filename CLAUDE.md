...
1. **Force install**: install the latest version of Prosedown. For example:`code --install-extension prosedown-1.0.8.vsix --force`. Refer Versioning section for more information on when the version changes.
